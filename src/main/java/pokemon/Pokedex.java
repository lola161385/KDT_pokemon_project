...
public class Pokedex {
    ...
    public static class PokedexData {
        ...
        static {
            ...
            addPokemon(9, "푸린", createTypes("특수"), "달", "모티브가 풍선인 귀여운 포켓몬",40 , "푸크린");
            addPokemon(10, "푸크린", createTypes("특수"),"달","푸린의 최종 진화형태",100,"최종 진화 단계");
            addPokemon(11, "고스트", createTypes("고스트"),"통신교환","통신교환으로 진화할 수 있음",100,"팬텀");
            addPokemon(12, "팬텀", createTypes("고스트"),"통신교환","통신교환을 통한 고스트의 최종 진화형태",100,"최종 진화 단계");
